                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-white">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="/menu" className="hover:text-orange-500 transition-colors">SERVICE</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center space-x-3">
                                ...
                                <span className="text-sm">+91 879 066 6095/+91 910 026 9331</span>
                            </li>
                            <li className="flex items-center space-x-3">
                                <Mail size={20} className="text-white" />
                                <span className="text-sm">ngrj.ram@gmail.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
