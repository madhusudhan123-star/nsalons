...
const ReviewSection = () => {
    ...
    const BookingForm = () => (
        <div className="w-full max-w-4xl mx-auto p-8 bg-gradient-to-b from-gray-900/50 to-transparent">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <h2 className="text-yellow-400 text-2xl font-medium">
                    Book your appointment here
                </h2>
                <p className="text-gray-300">
                    or call <span className="text-yellow-400">709 770 9722</span> to book an appointment.
                </p>
            </div>
            ...
            <button className="w-full mt-4 bg-yellow-400 text-black py-3 rounded hover:bg-yellow-500 transition-colors font-medium">
                Book an Appointment
            </button>
        </div>
    );
